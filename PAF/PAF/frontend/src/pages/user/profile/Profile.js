...
const Profile = ({ currentUser }) => {
  ...
  return (
    <>
      ...
      <header aria-label="Page Header" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1580820267682-426da823b514?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cG9ydHJhaXQlMjBiYWNrZ3JvdW5kfGVufDB8fDB8fA%3D%3D&w=1000&q=80')", backgroundSize: "cover" }}>
          ...
          <div className="flex mt-4 selection:items-center justify-center gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                <div
                  onClick={editProfile}
                  className="rounded-md p-1 px-4 font-semibold cursor-pointer text-gray-100 bg-blue-900 ml-auto"
                >
                  Edit Profile
                </div>
              </div>
              ...
              <div
                ...
                className="rounded-md p-1 px-4 font-semibold cursor-pointer text-gray-100 bg-blue-400 ml-auto"
              >
                Delete Profile
              </div>
            </div>
