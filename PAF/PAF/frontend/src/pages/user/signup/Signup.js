...
const Signup = ({authenticated}) => {
    ...
    return (
        <div className="signup-container h-screen" style={{
            backgroundImage: `url('https://www.thespruceeats.com/thmb/xZU9hdymsq5X3mVWMdsGzdDHnpU=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/GettyImages-164848482-5a44fe5847c2660036b7fc73.jpg')`,
